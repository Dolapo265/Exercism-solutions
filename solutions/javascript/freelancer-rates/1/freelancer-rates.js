...
export function priceWithMonthlyDiscount(ratePerHour, numDays, discount) {
 const hoursPerDay = 8;
  ...
  const totalDaysInMonths = fullMonths *  billableDaysInMonth;
  const discountedPrice = totalDaysInMonths * dailyRate * (1 - discount)

  const remainingPrice = remainingDays * dailyRate;
